...
def run_simulation(source_params, source_n, std_list, TOSSIT_locations, seed, localizer_params, loc0=None, bearing0=None, beamwidth=None, n_del=0):
...
if __name__ == "__main__":
    ...
    if args.save_figs:
        ...
        bins = np.arange(0,num_sources+1)+0.5
        for c, nd in enumerate(num_delete):
            dft = df_high[df_high['n_delete'] == nd]
            counts = []
