...
def run_simulation(source_params, var, TOSSIT_locations, rng, localizer_params):
    ...
    # simulate signals
    range_measurements_list, source_associations_list, TOSSIT_associations_list, source_locs_list, source_ids_list = sim_datagen.generate_simple_paths(source_params, var, TOSSIT_locations, rng)
